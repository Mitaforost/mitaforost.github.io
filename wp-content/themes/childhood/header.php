            ...
            <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                <div class="header__contacts">
                    <div class="header__contacts-item">
                        <img src="<?php echo bloginfo('template_url'); ?>/assets/img/icons/svg/email.svg" alt="почта"
                             class="header__contacts-logo">
                        <a href="<?php the_field('mail', 2); ?>"
                    ...
                    <div class="header__contacts-item">
                        ...
                        <div class="header__contacts-tel">
                            <a href="tel:<?php the_field('number_phone', 2); ?>"><?php the_field('number_phone', 2); ?></a>
                            <a href="tel:<?php the_field('number_phone_two', 2); ?>"><?php the_field('number_phone_two', 2); ?></a>
                        </div>
                    </div>
                    <div class="header__contacts-item">
